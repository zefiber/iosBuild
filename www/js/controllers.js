angular.module('starter.controllers', [])
    ...
    .controller('LoginCtrl', function ($rootScope, $scope, $state, $location, $log, $ionicPopup, $ionicActionSheet, $timeout, $rootScope, pageNameService, signInService) {
    ...
    .controller('detailWatchListCtrl', function ($scope, $state, $location, $log, $ionicPopup, $ionicActionSheet, $timeout, pageNameService, localStorageService, socketServ) {
        ...
        $scope.connectSocket = function () {
            ...
            // var sendStockIdsJson = angular.toJson(sendStockIds);
    ...
    .controller('SignUpCtrl', function ($rootScope, $scope, $location, $log, $ionicPopup, $ionicLoading, pageNameService, signUpService) {
        ...
        $scope.createNewUser = function () {
            ...
            signUpService.create($scope.model).then(
                function success(data) {
                    console.log("data failreason:" + data.failreason);
                    if (data && data.success == false) {
                        $ionicPopup.alert({
                            title: 'Sign-up Failed',
                            template: data.failreason
                        });
                        return;
                    }
                    console.log("create new user success:" + data.account);
                    $location.path('/login');
                },
                function error(err) {
    ...
    .controller('AcctHoldingsCtrl', function ($scope, $location, $log, $ionicPopup, $ionicLoading, pageNameService, localStorageService, socketServ) {
